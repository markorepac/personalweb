...
const PROJECT_GROUPS = [
  {
    ...
    projects: [
      { title: 'Plate Cooling', description: 'Numerical model for plate cooling.', link: '/plate_cooling', thumbnail: '/images/gisapp.png' }
    ]
  },
  {
    key: 'geochemistry',
    ...
    projects: [
      { title: 'Whole Rock (WR)', description: 'Geochemical research suite.', link: '/wr', thumbnail: '/images/gisapp.png' }
    ]
  },
  {
    key: 'datascience',
    label: 'Data Science',
    projects: [
      { title: 'ML Task', description: 'Machine learning exploration.', link: '/mltask', thumbnail: '/images/gisapp.png' }
    ]
  },
  {
    key: 'gis',
    ...
    projects: [
      { title: 'CroGIS App', description: 'GIS and remote sensing application.', link: '/cro_gis_app', thumbnail: '/images/gisapp.png' }
    ]
  }
];
